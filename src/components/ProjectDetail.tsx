...
const ProjectDetai: React.FC<ProjectDetailProps> = ({ isOpen, isCreate, data, categories, onClose, onSubmit }) => {
    ...
    return (
        <>
            <Modal
                ...
                destroyOnClose
            >
                <Form onFinish={onSubmit} form={form} layout="vertical" name="projectDetailForm">
                    ...
                    <Form.Item
                        label="Project alias"
                        name="alias"
                        rules={[{ required: true, message: 'Please input your project alias!' }]}
                    >
                    ...
                    <Form.Item
                        ...
                        rules={[{ required: true, message: 'Please input your project category!' }]}
                    >
                        <Select
                            style={{ width: 120 }}
